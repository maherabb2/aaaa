...
import com.hipermarket.CategorieProdus;
import com.hipermarket.fisiere.CitireFisier;
import com.hipermarket.Produs;
import com.hipermarket.TipCantitate;
...
public class MeniuClient implements Meniu {
    ...
    public Meniu interpreteazaComanda(char c) {
        ...
        switch (c) {
            ...
            case '0':
                ...
                // Aici menu ar trebui sa aiba valloarea com.hipermarket.meniuri.MeniuPrincipal
                break;
            default:
    ...
    private void scaneazaProdus() {
        ...
        CitireFisier citire = new CitireFisier(messages);
        String mesaj = citire.citireString();
        String[] date = mesaj.split(";");
        produsId = Integer.parseInt(date[0]);
        produsCantitate = Float.parseFloat(date[1]);
        ...
        citire = new CitireFisier(fisierProduse);
        String[] produseCitite = citire.citireString().split("\n");
        for (String produsCitit: produseCitite) {
            String[] elemente = produsCitit.split(";");
